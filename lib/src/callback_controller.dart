...
class Throttler extends CallbackController {
  ...
  Throttler({super.duration = defaultDuration});
  ...
  void call(VoidCallback callback) {
    ...
    callback();
    _isThrottled = true;
    timer = Timer(duration, () => _isThrottled = false);
  }
...
class Debouncer extends CallbackController {
  ...
  Debouncer({super.duration = defaultDuration});
...
class AsyncDebouncer {
  ...
  AsyncDebouncer({this.duration = defaultDuration});
...
class AsyncThrottler {
  ...
  AsyncThrottler({this.maxDuration = const Duration(seconds: 15)});
